...
public class B implements Letter
{
   ...
   public Paths getPaths()
   {
      ...
      paths.add(new Path(0, Letter.MAX_HEIGHT / 2, Path.MovementType.START));
      paths.add(new Path(B_CURVE_WIDTH, Letter.MAX_HEIGHT / 2, Path.MovementType.LINE));


      int centerX = B_CURVE_WIDTH;
      int centerY = Letter.MAX_HEIGHT * 3 / 4;
      final int radiusX = Letter.WIDTH - B_CURVE_WIDTH;
      final int radiusY = Letter.MAX_HEIGHT / 4;
