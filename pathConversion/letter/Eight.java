...
public class Eight implements Letter
{
   public static final int CENTER_X = Dimensions.getRelativeX(Dimensions.MAX_WIDTH_80, 1, 2);

   public static final int FIRST_STARTING_ANGLE = Letter.DISCRETE_POINTS * 270/360; 
   public static final int FIRST_ENDING_ANGLE = Letter.DISCRETE_POINTS * 630/360; 
   ...
   public static final int SECOND_ENDING_ANGLE = Letter.DISCRETE_POINTS * 90/360;
   public static final int SECOND_RADIUS_X = Dimensions.getRelativeX(Dimensions.MAX_WIDTH_80, 1, 2);

   public static final int SECOND_STARTING_ANGLE = Letter.DISCRETE_POINTS * 450/360;
   ...
   {
      Paths paths = new Paths(Dimensions.WIDTH_80, Dimensions.HEIGHT, "8");
