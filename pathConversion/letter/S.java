...
public class S implements Letter
{
   ...
   public static final int FIRST_STARTING_ANGLE = Letter.DISCRETE_POINTS * 40 / 360;
   public static final int FIRST_ENDING_ANGLE = Letter.DISCRETE_POINTS * 270 / 360;
   ...
   public static final int SECOND_ENDING_ANGLE = Letter.DISCRETE_POINTS * (200 - 360) / 360;
   public static final int SECOND_RADIUS_X = Dimensions.getRelativeX(Dimensions.MAX_WIDTH_80, 1, 2);

   public static final int SECOND_STARTING_ANGLE = FIRST_ENDING_ANGLE - Letter.DISCRETE_POINTS / 2;
   ...
   {
      Paths paths = new Paths(Dimensions.WIDTH_80, Dimensions.HEIGHT, "S");
